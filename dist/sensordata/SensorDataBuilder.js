...
const BackgroundEventList_1 = __importDefault(require("./BackgroundEventList"));
const KeyEventList_1 = __importDefault(require("./KeyEventList"));
const PerformanceTestResults_1 = __importDefault(require("./PerformanceTestResults"));
const SensorDataEncryptor_1 = __importDefault(require("./SensorDataEncryptor"));
const SystemInfo_1 = __importDefault(require("./SystemInfo"));
const TouchEventList_1 = __importDefault(require("./TouchEventList"));
...
class SensorDataBuilder {
    constructor() {
        ...
        this.deviceInfoTime = SensorDataUtil_1.randBetween(3, 8) * 1000;
        this.systemInfo = new SystemInfo_1.default();
        this.systemInfo.randomize();
        this.touchEventList = new TouchEventList_1.default();
        this.keyEventList = new KeyEventList_1.default();
        this.backgroundEventList = new BackgroundEventList_1.default();
        this.performanceTestResults = new PerformanceTestResults_1.default();
        this.performanceTestResults.randomize();
        this.sensorDataEncryptor = new SensorDataEncryptor_1.default();
    }
    generateSensorData() {
    ...
    */
    generateMotionDataAA() {
        return "";
    }
    /* examples:
    2;198.00;1719.00;969190507;}127A
    */
    generateOrientationDataAC() {
        return "";
    }
    /* examples:
    ...
    2;198.00;1719.00;969190507;}127A
    */
    generateOrientationDataAB() {
        return "";
    }
    /* examples:
    2;198.00;301.00;2428178775;}40BC68BDA16B
    */
    generateMotionDataAC() {
        return "";
    }
    /* examples:
    ...
    */
    generateMiscStat(orientationDataCount, motionDataCount) {
        ...
        return [
            ...
            motionDataCount,
            this.deviceInfoTime,
            SensorDataUtil_1.randBetween(5, 15) * 1000,
            0,
            SensorDataUtil_1.feistelCipher(sum, this.keyEventList.keyEvents.length + this.touchEventList.touchEvents.length + orientationDataCount + motionDataCount, timeSinceSensorCollectionStart),
            this.sensorCollectionStartTimestamp,
            0
        ].join(",");
    }
    generateStoredValuesF() {
        return "-1";
    }
    generateStoredValuesG() {
        return "0";
    }
    generateStoredStackTraces() {
        return "";
    }
}
exports.default = SensorDataBuilder;
//# sourceMappingURL=SensorDataBuilder.js.map