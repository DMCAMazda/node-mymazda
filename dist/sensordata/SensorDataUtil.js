...
exports.feistelCipher = exports.sumCharCodes = exports.percentEncode = exports.selectRandomFromArray = exports.parseSensorDataStr = exports.randBetween = void 0;
function randBetween(min, max) {
    return Math.floor(Math.random() * (max - min) + min);
}
exports.randBetween = randBetween;
function parseSensorDataStr(data) {
    function getAndAdd(obj, key, delimiter) {
...
function feistelCipher(upper32Bits, lower32Bits, key) {
    ...
    let iterate = function (arg1, arg2, arg3) {
...
exports.feistelCipher = feistelCipher;
//# sourceMappingURL=SensorDataUtil.js.map